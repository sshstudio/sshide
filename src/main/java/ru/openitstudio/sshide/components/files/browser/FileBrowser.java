package ru.openitstudio.sshide.components.files.browser;
...
import ru.openitstudio.sshide.components.files.browser.local.LocalFileBrowserView;
import ru.openitstudio.sshide.components.files.browser.sftp.SftpFileBrowserView;
